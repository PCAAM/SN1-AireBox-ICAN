...
REM # Version: @(#)Reboot Envio v.2.8.6.0 // 26-09-13 arce@redcitroen.com

REM # "-----  Reboot de servicio Envio_DCS correspondiente a la instancia  -----"
...
cd %RUTA%
FOR %%F IN (daemon_envioDCS*.bat) DO SET NFICHERO=%%F
