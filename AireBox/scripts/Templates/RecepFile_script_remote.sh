...
# Version: @(#)sftp v.2.8.6.0 // 26-09-13 arce@redcitroen.com

# "-----  Recepcion por sFTP de la DMZ del fichero  -----"
# Sustituir NOMBRE_CIBLE,NOMBRE_DMS,NOMBRE_SFTP por sus valores correctos

NOM_ENVIO=NOMBRE_CIBLE
FILE_SOURCE=NOMBRE_CIBLE
FILE_DESTINATION=NOMBRE_DMS
URL_SFTP=NOMBRE_SFTP
...
echo "*********************************** Proceso de recepcion *************************************************" 	>> ""$PATH_AIREBOX""/Suite_DCS/Log/$NOM_LOG 2>&1
...
echo "*********************************** Fin Proceso de recepcion *********************************************" 	>> ""$PATH_AIREBOX""/Suite_DCS/Log/$NOM_LOG 2>&1 
